...
class LittleLogicalMatthew:
    ...
    def __init__(self):
        self.chatbot_connections = {"analysis": chatbot(), "advice": chatbot(), "convo": chatbot()}
        self.bot = "analysis"
    ...
    def initialise_chatbots(self):
        ...
        self.chatbot_connections["advice"].set_preset("You are a helpful assistant advising the user on career decisions")
        self.chatbot_connections["convo"].set_preset("You are having a conversation with a friend")
